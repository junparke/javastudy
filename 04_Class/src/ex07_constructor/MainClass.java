...
public class MainClass {
	...
	public static void ex01() {
		...
		User user1 = new User(); //user 객체 생성(user()생성자 호출)
		

		user1.info(); 	//User1의 info 메소드 호출
		
		//User 객체 생성 (User(String userId, String userPw) 생성호출)
	...
	public static void ex02() {
		...
		book3.info(); // 제목: 소나기, 저자 : 황숭원, 가격 : 100000원
	}	
